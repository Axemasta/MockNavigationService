namespace Axemasta.MockNavigationService.Helpers
{
    ...
    {
        /// <summary>
        /// Prism Uri navigation can now be either Page or ViewModel based. This means that if the
        /// user sets up MainPage but uses the navigation builder then their verification will fail
        /// since it will build a Uri with the viewmodel name, not the page name this method makes
        /// it easier to setup verification uri's
        /// </summary>
